...
sed "s/MONITOR/${MONITOR}/g;" run5f.smv.template > run.${MONITOR}.smv.tmp
sed "s/PROPERTY/${PROPERTY}/g" run.${MONITOR}.smv.tmp > run.${MONITOR}.smv.tmp2
sed "s/DIFF/${DIFF}/g" run.${MONITOR}.smv.tmp2 > run.${MONITOR}.smv
rm -f run.${MONITOR}.smv.tmp run.${MONITOR}.smv.tmp2
