...
public final class PatternTests {
	...
	while (e.hasMoreElements()) {
		...
		switch (s) {
		case 0:
		    rvm.P52RuntimeMonitor.pEvent(v);
		    break;
		case 1:
		    rvm.P52RuntimeMonitor.qEvent(v);
		    break;
		case 2:
		    rvm.P52RuntimeMonitor.rEvent(v);
		    break;
		case 3:
		    rvm.P52RuntimeMonitor.sEvent(v);
		    break;
		case 4:
		    rvm.P52RuntimeMonitor.tEvent(v);
		    break;
		case 5:
		    rvm.P52RuntimeMonitor.zEvent(v);
		    break;
		}
